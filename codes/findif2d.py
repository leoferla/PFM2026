...
if (__name__ == '__main__'):
    ...
    for j in range (1,m+1):
        for i in range (1,n+1):
            ...
            a [k,we] = -c11 * theta * x[i]**2 * dx2i
            a [k,ea] = -c11 * theta * x[i]**2 * dx2i
            a [k,no] = -c22 * theta * dy2i
            a [k,so] = -c22 * theta * dy2i
            a [k,nw] = c12 * theta * x[i] / (4.0 * dx * dy)
            a [k,ne] = -c12 * theta * x[i] / (4.0 * dx * dy)
            a [k,sw] = -c12 * theta * x[i] / (4.0 * dx * dy)
            a [k,se] = c12 * theta * x[i] / (4.0 * dx * dy)
    ...
    for it in range (nt):
        ...
        for j in range (1,m+1):
            for i in range (1,n+1):
                ...
                b [k] = uold [k] / dt + c11 * th1 * x[i]**2 * (uold[we] - 2.0 * uold[k] + uold[ea]) * dx2i \
                                      + c12 * th1 * (uold[ne] - uold[se] - uold[nw] + uold[sw]) / (4.0 * dx * dy) \
